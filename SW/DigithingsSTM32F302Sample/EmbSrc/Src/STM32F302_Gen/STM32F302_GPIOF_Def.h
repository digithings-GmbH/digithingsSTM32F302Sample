// Base Addres of GPIOF = 0x48001400

#define STM32F302_GPIOF_MODER_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOF_MODER;

typedef union {
    sSTM32F302_GPIOF_MODER Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_MODER;

#define STM32F302_GPIOF_OTYPER_RESET_VALUE 0x00000000
typedef struct {
    unsigned long OT0 : 1;
    unsigned long OT1 : 1;
    unsigned long OT2 : 1;
...
} sSTM32F302_GPIOF_OTYPER;

typedef union {
    sSTM32F302_GPIOF_OTYPER Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_OTYPER;

#define STM32F302_GPIOF_OSPEEDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOF_OSPEEDR;

typedef union {
    sSTM32F302_GPIOF_OSPEEDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_OSPEEDR;

#define STM32F302_GPIOF_PUPDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOF_PUPDR;

typedef union {
    sSTM32F302_GPIOF_PUPDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_PUPDR;

#define STM32F302_GPIOF_IDR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOF_IDR;

typedef union {
    sSTM32F302_GPIOF_IDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_IDR;

#define STM32F302_GPIOF_ODR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOF_ODR;

typedef union {
    sSTM32F302_GPIOF_ODR Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_ODR;

#define STM32F302_GPIOF_BSRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BS0 : 1;
    unsigned long BS1 : 1;
    unsigned long BS2 : 1;
...
} sSTM32F302_GPIOF_BSRR;

typedef union {
    sSTM32F302_GPIOF_BSRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_BSRR;

#define STM32F302_GPIOF_LCKR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOF_LCKR;

typedef union {
    sSTM32F302_GPIOF_LCKR Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_LCKR;

#define STM32F302_GPIOF_AFRL_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOF_AFRL;

typedef union {
    sSTM32F302_GPIOF_AFRL Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_AFRL;

#define STM32F302_GPIOF_AFRH_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOF_AFRH;

typedef union {
    sSTM32F302_GPIOF_AFRH Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_AFRH;

#define STM32F302_GPIOF_BRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BR0 : 1;
    unsigned long BR1 : 1;
    unsigned long BR2 : 1;
    ...
    unsigned long BR15 : 1;
    unsigned long Res0 : 16;
} sSTM32F302_GPIOF_BRR;

typedef union {
    sSTM32F302_GPIOF_BRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOF_BRR;

typedef struct {
    uSTM32F302_GPIOF_MODER STM32F302_GPIOF_MODER; // Offset: 0x0
    uSTM32F302_GPIOF_OTYPER STM32F302_GPIOF_OTYPER; // Offset: 0x4
    uSTM32F302_GPIOF_OSPEEDR STM32F302_GPIOF_OSPEEDR; // Offset: 0x8
    uSTM32F302_GPIOF_PUPDR STM32F302_GPIOF_PUPDR; // Offset: 0xc
    uSTM32F302_GPIOF_IDR STM32F302_GPIOF_IDR; // Offset: 0x10
    uSTM32F302_GPIOF_ODR STM32F302_GPIOF_ODR; // Offset: 0x14
    uSTM32F302_GPIOF_BSRR STM32F302_GPIOF_BSRR; // Offset: 0x18
    uSTM32F302_GPIOF_LCKR STM32F302_GPIOF_LCKR; // Offset: 0x1c
    uSTM32F302_GPIOF_AFRL STM32F302_GPIOF_AFRL; // Offset: 0x20
    uSTM32F302_GPIOF_AFRH STM32F302_GPIOF_AFRH; // Offset: 0x24
    uSTM32F302_GPIOF_BRR STM32F302_GPIOF_BRR; // Offset: 0x28
} sSTM32F302_GPIOF;
