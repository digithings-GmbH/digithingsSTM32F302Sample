// Base Addres of ADC3_4 = 0x50000700

#define STM32F302_ADC3_4_CSR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_ADC3_4_CSR;

typedef union {
    sSTM32F302_ADC3_4_CSR Bit;
    unsigned long  All;
} uSTM32F302_ADC3_4_CSR;

#define STM32F302_ADC3_4_CCR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_ADC3_4_CCR;

typedef union {
    sSTM32F302_ADC3_4_CCR Bit;
    unsigned long  All;
} uSTM32F302_ADC3_4_CCR;

#define STM32F302_ADC3_4_CDR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long RDATA_MST : 16;
    unsigned long RDATA_SLV : 16;
} sSTM32F302_ADC3_4_CDR;

typedef union {
    sSTM32F302_ADC3_4_CDR Bit;
    unsigned long  All;
} uSTM32F302_ADC3_4_CDR;

typedef struct {
    uSTM32F302_ADC3_4_CSR STM32F302_ADC3_4_CSR; // Offset: 0x0
    unsigned long Reserved0;
    uSTM32F302_ADC3_4_CCR STM32F302_ADC3_4_CCR; // Offset: 0x8
    uSTM32F302_ADC3_4_CDR STM32F302_ADC3_4_CDR; // Offset: 0xc
} sSTM32F302_ADC3_4;
