// Base Addres of GPIOA = 0x48000000

#define STM32F302_GPIOA_MODER_RESET_VALUE 0x28000000
typedef struct {
...
} sSTM32F302_GPIOA_MODER;

typedef union {
    sSTM32F302_GPIOA_MODER Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_MODER;

#define STM32F302_GPIOA_OTYPER_RESET_VALUE 0x00000000
typedef struct {
    unsigned long OT0 : 1;
    unsigned long OT1 : 1;
    unsigned long OT2 : 1;
...
} sSTM32F302_GPIOA_OTYPER;

typedef union {
    sSTM32F302_GPIOA_OTYPER Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_OTYPER;

#define STM32F302_GPIOA_OSPEEDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOA_OSPEEDR;

typedef union {
    sSTM32F302_GPIOA_OSPEEDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_OSPEEDR;

#define STM32F302_GPIOA_PUPDR_RESET_VALUE 0x24000000
typedef struct {
...
} sSTM32F302_GPIOA_PUPDR;

typedef union {
    sSTM32F302_GPIOA_PUPDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_PUPDR;

#define STM32F302_GPIOA_IDR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOA_IDR;

typedef union {
    sSTM32F302_GPIOA_IDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_IDR;

#define STM32F302_GPIOA_ODR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOA_ODR;

typedef union {
    sSTM32F302_GPIOA_ODR Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_ODR;

#define STM32F302_GPIOA_BSRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BS0 : 1;
    unsigned long BS1 : 1;
    unsigned long BS2 : 1;
...
} sSTM32F302_GPIOA_BSRR;

typedef union {
    sSTM32F302_GPIOA_BSRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_BSRR;

#define STM32F302_GPIOA_LCKR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOA_LCKR;

typedef union {
    sSTM32F302_GPIOA_LCKR Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_LCKR;

#define STM32F302_GPIOA_AFRL_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOA_AFRL;

typedef union {
    sSTM32F302_GPIOA_AFRL Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_AFRL;

#define STM32F302_GPIOA_AFRH_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOA_AFRH;

typedef union {
    sSTM32F302_GPIOA_AFRH Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_AFRH;

#define STM32F302_GPIOA_BRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BR0 : 1;
    unsigned long BR1 : 1;
    unsigned long BR2 : 1;
    ...
    unsigned long BR15 : 1;
    unsigned long Res0 : 16;
} sSTM32F302_GPIOA_BRR;

typedef union {
    sSTM32F302_GPIOA_BRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOA_BRR;

typedef struct {
    uSTM32F302_GPIOA_MODER STM32F302_GPIOA_MODER; // Offset: 0x0
    uSTM32F302_GPIOA_OTYPER STM32F302_GPIOA_OTYPER; // Offset: 0x4
    uSTM32F302_GPIOA_OSPEEDR STM32F302_GPIOA_OSPEEDR; // Offset: 0x8
    uSTM32F302_GPIOA_PUPDR STM32F302_GPIOA_PUPDR; // Offset: 0xc
    uSTM32F302_GPIOA_IDR STM32F302_GPIOA_IDR; // Offset: 0x10
    uSTM32F302_GPIOA_ODR STM32F302_GPIOA_ODR; // Offset: 0x14
    uSTM32F302_GPIOA_BSRR STM32F302_GPIOA_BSRR; // Offset: 0x18
    uSTM32F302_GPIOA_LCKR STM32F302_GPIOA_LCKR; // Offset: 0x1c
    uSTM32F302_GPIOA_AFRL STM32F302_GPIOA_AFRL; // Offset: 0x20
    uSTM32F302_GPIOA_AFRH STM32F302_GPIOA_AFRH; // Offset: 0x24
    uSTM32F302_GPIOA_BRR STM32F302_GPIOA_BRR; // Offset: 0x28
} sSTM32F302_GPIOA;
