// Base Addres of UART4 = 0x40004C00

#define STM32F302_UART4_CR1_RESET_VALUE 0x0000
typedef struct {
    unsigned long UE : 1;
...
} sSTM32F302_UART4_CR1;

typedef union {
    sSTM32F302_UART4_CR1 Bit;
    unsigned long  All;
} uSTM32F302_UART4_CR1;

#define STM32F302_UART4_CR2_RESET_VALUE 0x0000
typedef struct {
    unsigned long Res0 : 4;
...
} sSTM32F302_UART4_CR2;

typedef union {
    sSTM32F302_UART4_CR2 Bit;
    unsigned long  All;
} uSTM32F302_UART4_CR2;

#define STM32F302_UART4_CR3_RESET_VALUE 0x0000
typedef struct {
    unsigned long EIE : 1;
...
} sSTM32F302_UART4_CR3;

typedef union {
    sSTM32F302_UART4_CR3 Bit;
    unsigned long  All;
} uSTM32F302_UART4_CR3;

#define STM32F302_UART4_BRR_RESET_VALUE 0x0000
typedef struct {
    unsigned long DIV_Fraction : 4;
    unsigned long DIV_Mantissa : 12;
    unsigned long Res0 : 16;
} sSTM32F302_UART4_BRR;

typedef union {
    sSTM32F302_UART4_BRR Bit;
    unsigned long  All;
} uSTM32F302_UART4_BRR;

#define STM32F302_UART4_GTPR_RESET_VALUE 0x0000
typedef struct {
    unsigned long PSC : 8;
    unsigned long GT : 8;
    unsigned long Res0 : 16;
} sSTM32F302_UART4_GTPR;

typedef union {
    sSTM32F302_UART4_GTPR Bit;
    unsigned long  All;
} uSTM32F302_UART4_GTPR;

#define STM32F302_UART4_RTOR_RESET_VALUE 0x0000
typedef struct {
    unsigned long RTO : 24;
    unsigned long BLEN : 8;
} sSTM32F302_UART4_RTOR;

typedef union {
    sSTM32F302_UART4_RTOR Bit;
    unsigned long  All;
} uSTM32F302_UART4_RTOR;

#define STM32F302_UART4_RQR_RESET_VALUE 0x0000
typedef struct {
...
} sSTM32F302_UART4_RQR;

typedef union {
    sSTM32F302_UART4_RQR Bit;
    unsigned long  All;
} uSTM32F302_UART4_RQR;

#define STM32F302_UART4_ISR_RESET_VALUE 0x00C0
typedef struct {
    unsigned long PE : 1;
    unsigned long FE : 1;
    unsigned long NF : 1;
    ...
    unsigned long Res1 : 9;
} sSTM32F302_UART4_ISR;

typedef union {
    sSTM32F302_UART4_ISR Bit;
    unsigned long  All;
} uSTM32F302_UART4_ISR;

#define STM32F302_UART4_ICR_RESET_VALUE 0x0000
typedef struct {
...
} sSTM32F302_UART4_ICR;

typedef union {
    sSTM32F302_UART4_ICR Bit;
    unsigned long  All;
} uSTM32F302_UART4_ICR;

#define STM32F302_UART4_RDR_RESET_VALUE 0x0000
typedef struct {
    unsigned long RDR : 9;
    unsigned long Res0 : 23;
} sSTM32F302_UART4_RDR;

typedef union {
    sSTM32F302_UART4_RDR Bit;
    unsigned long  All;
} uSTM32F302_UART4_RDR;

#define STM32F302_UART4_TDR_RESET_VALUE 0x0000
typedef struct {
    unsigned long TDR : 9;
    unsigned long Res0 : 23;
} sSTM32F302_UART4_TDR;

typedef union {
    sSTM32F302_UART4_TDR Bit;
    unsigned long  All;
} uSTM32F302_UART4_TDR;

typedef struct {
    uSTM32F302_UART4_CR1 STM32F302_UART4_CR1; // Offset: 0x0
    uSTM32F302_UART4_CR2 STM32F302_UART4_CR2; // Offset: 0x4
    uSTM32F302_UART4_CR3 STM32F302_UART4_CR3; // Offset: 0x8
    uSTM32F302_UART4_BRR STM32F302_UART4_BRR; // Offset: 0xc
    uSTM32F302_UART4_GTPR STM32F302_UART4_GTPR; // Offset: 0x10
    uSTM32F302_UART4_RTOR STM32F302_UART4_RTOR; // Offset: 0x14
    uSTM32F302_UART4_RQR STM32F302_UART4_RQR; // Offset: 0x18
    uSTM32F302_UART4_ISR STM32F302_UART4_ISR; // Offset: 0x1c
    uSTM32F302_UART4_ICR STM32F302_UART4_ICR; // Offset: 0x20
    uSTM32F302_UART4_RDR STM32F302_UART4_RDR; // Offset: 0x24
    uSTM32F302_UART4_TDR STM32F302_UART4_TDR; // Offset: 0x28
} sSTM32F302_UART4;
