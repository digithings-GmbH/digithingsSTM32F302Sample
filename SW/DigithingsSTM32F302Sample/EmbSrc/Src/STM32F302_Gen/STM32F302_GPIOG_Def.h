// Base Addres of GPIOG = 0x48001800

#define STM32F302_GPIOG_MODER_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOG_MODER;

typedef union {
    sSTM32F302_GPIOG_MODER Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_MODER;

#define STM32F302_GPIOG_OTYPER_RESET_VALUE 0x00000000
typedef struct {
    unsigned long OT0 : 1;
    unsigned long OT1 : 1;
    unsigned long OT2 : 1;
...
} sSTM32F302_GPIOG_OTYPER;

typedef union {
    sSTM32F302_GPIOG_OTYPER Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_OTYPER;

#define STM32F302_GPIOG_OSPEEDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOG_OSPEEDR;

typedef union {
    sSTM32F302_GPIOG_OSPEEDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_OSPEEDR;

#define STM32F302_GPIOG_PUPDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOG_PUPDR;

typedef union {
    sSTM32F302_GPIOG_PUPDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_PUPDR;

#define STM32F302_GPIOG_IDR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOG_IDR;

typedef union {
    sSTM32F302_GPIOG_IDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_IDR;

#define STM32F302_GPIOG_ODR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOG_ODR;

typedef union {
    sSTM32F302_GPIOG_ODR Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_ODR;

#define STM32F302_GPIOG_BSRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BS0 : 1;
    unsigned long BS1 : 1;
    unsigned long BS2 : 1;
...
} sSTM32F302_GPIOG_BSRR;

typedef union {
    sSTM32F302_GPIOG_BSRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_BSRR;

#define STM32F302_GPIOG_LCKR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOG_LCKR;

typedef union {
    sSTM32F302_GPIOG_LCKR Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_LCKR;

#define STM32F302_GPIOG_AFRL_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOG_AFRL;

typedef union {
    sSTM32F302_GPIOG_AFRL Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_AFRL;

#define STM32F302_GPIOG_AFRH_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOG_AFRH;

typedef union {
    sSTM32F302_GPIOG_AFRH Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_AFRH;

#define STM32F302_GPIOG_BRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BR0 : 1;
    unsigned long BR1 : 1;
    unsigned long BR2 : 1;
    ...
    unsigned long BR15 : 1;
    unsigned long Res0 : 16;
} sSTM32F302_GPIOG_BRR;

typedef union {
    sSTM32F302_GPIOG_BRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOG_BRR;

typedef struct {
    uSTM32F302_GPIOG_MODER STM32F302_GPIOG_MODER; // Offset: 0x0
    uSTM32F302_GPIOG_OTYPER STM32F302_GPIOG_OTYPER; // Offset: 0x4
    uSTM32F302_GPIOG_OSPEEDR STM32F302_GPIOG_OSPEEDR; // Offset: 0x8
    uSTM32F302_GPIOG_PUPDR STM32F302_GPIOG_PUPDR; // Offset: 0xc
    uSTM32F302_GPIOG_IDR STM32F302_GPIOG_IDR; // Offset: 0x10
    uSTM32F302_GPIOG_ODR STM32F302_GPIOG_ODR; // Offset: 0x14
    uSTM32F302_GPIOG_BSRR STM32F302_GPIOG_BSRR; // Offset: 0x18
    uSTM32F302_GPIOG_LCKR STM32F302_GPIOG_LCKR; // Offset: 0x1c
    uSTM32F302_GPIOG_AFRL STM32F302_GPIOG_AFRL; // Offset: 0x20
    uSTM32F302_GPIOG_AFRH STM32F302_GPIOG_AFRH; // Offset: 0x24
    uSTM32F302_GPIOG_BRR STM32F302_GPIOG_BRR; // Offset: 0x28
} sSTM32F302_GPIOG;
