// Base Addres of GPIOE = 0x48001000

#define STM32F302_GPIOE_MODER_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOE_MODER;

typedef union {
    sSTM32F302_GPIOE_MODER Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_MODER;

#define STM32F302_GPIOE_OTYPER_RESET_VALUE 0x00000000
typedef struct {
    unsigned long OT0 : 1;
    unsigned long OT1 : 1;
    unsigned long OT2 : 1;
...
} sSTM32F302_GPIOE_OTYPER;

typedef union {
    sSTM32F302_GPIOE_OTYPER Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_OTYPER;

#define STM32F302_GPIOE_OSPEEDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOE_OSPEEDR;

typedef union {
    sSTM32F302_GPIOE_OSPEEDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_OSPEEDR;

#define STM32F302_GPIOE_PUPDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOE_PUPDR;

typedef union {
    sSTM32F302_GPIOE_PUPDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_PUPDR;

#define STM32F302_GPIOE_IDR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOE_IDR;

typedef union {
    sSTM32F302_GPIOE_IDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_IDR;

#define STM32F302_GPIOE_ODR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOE_ODR;

typedef union {
    sSTM32F302_GPIOE_ODR Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_ODR;

#define STM32F302_GPIOE_BSRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BS0 : 1;
    unsigned long BS1 : 1;
    unsigned long BS2 : 1;
...
} sSTM32F302_GPIOE_BSRR;

typedef union {
    sSTM32F302_GPIOE_BSRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_BSRR;

#define STM32F302_GPIOE_LCKR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOE_LCKR;

typedef union {
    sSTM32F302_GPIOE_LCKR Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_LCKR;

#define STM32F302_GPIOE_AFRL_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOE_AFRL;

typedef union {
    sSTM32F302_GPIOE_AFRL Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_AFRL;

#define STM32F302_GPIOE_AFRH_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOE_AFRH;

typedef union {
    sSTM32F302_GPIOE_AFRH Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_AFRH;

#define STM32F302_GPIOE_BRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BR0 : 1;
    unsigned long BR1 : 1;
    unsigned long BR2 : 1;
    ...
    unsigned long BR15 : 1;
    unsigned long Res0 : 16;
} sSTM32F302_GPIOE_BRR;

typedef union {
    sSTM32F302_GPIOE_BRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOE_BRR;

typedef struct {
    uSTM32F302_GPIOE_MODER STM32F302_GPIOE_MODER; // Offset: 0x0
    uSTM32F302_GPIOE_OTYPER STM32F302_GPIOE_OTYPER; // Offset: 0x4
    uSTM32F302_GPIOE_OSPEEDR STM32F302_GPIOE_OSPEEDR; // Offset: 0x8
    uSTM32F302_GPIOE_PUPDR STM32F302_GPIOE_PUPDR; // Offset: 0xc
    uSTM32F302_GPIOE_IDR STM32F302_GPIOE_IDR; // Offset: 0x10
    uSTM32F302_GPIOE_ODR STM32F302_GPIOE_ODR; // Offset: 0x14
    uSTM32F302_GPIOE_BSRR STM32F302_GPIOE_BSRR; // Offset: 0x18
    uSTM32F302_GPIOE_LCKR STM32F302_GPIOE_LCKR; // Offset: 0x1c
    uSTM32F302_GPIOE_AFRL STM32F302_GPIOE_AFRL; // Offset: 0x20
    uSTM32F302_GPIOE_AFRH STM32F302_GPIOE_AFRH; // Offset: 0x24
    uSTM32F302_GPIOE_BRR STM32F302_GPIOE_BRR; // Offset: 0x28
} sSTM32F302_GPIOE;
