// Base Addres of GPIOC = 0x48000800

#define STM32F302_GPIOC_MODER_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOC_MODER;

typedef union {
    sSTM32F302_GPIOC_MODER Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_MODER;

#define STM32F302_GPIOC_OTYPER_RESET_VALUE 0x00000000
typedef struct {
    unsigned long OT0 : 1;
    unsigned long OT1 : 1;
    unsigned long OT2 : 1;
...
} sSTM32F302_GPIOC_OTYPER;

typedef union {
    sSTM32F302_GPIOC_OTYPER Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_OTYPER;

#define STM32F302_GPIOC_OSPEEDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOC_OSPEEDR;

typedef union {
    sSTM32F302_GPIOC_OSPEEDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_OSPEEDR;

#define STM32F302_GPIOC_PUPDR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOC_PUPDR;

typedef union {
    sSTM32F302_GPIOC_PUPDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_PUPDR;

#define STM32F302_GPIOC_IDR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOC_IDR;

typedef union {
    sSTM32F302_GPIOC_IDR Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_IDR;

#define STM32F302_GPIOC_ODR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32F302_GPIOC_ODR;

typedef union {
    sSTM32F302_GPIOC_ODR Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_ODR;

#define STM32F302_GPIOC_BSRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BS0 : 1;
    unsigned long BS1 : 1;
    unsigned long BS2 : 1;
...
} sSTM32F302_GPIOC_BSRR;

typedef union {
    sSTM32F302_GPIOC_BSRR Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_BSRR;

#define STM32F302_GPIOC_LCKR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOC_LCKR;

typedef union {
    sSTM32F302_GPIOC_LCKR Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_LCKR;

#define STM32F302_GPIOC_AFRL_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOC_AFRL;

typedef union {
    sSTM32F302_GPIOC_AFRL Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_AFRL;

#define STM32F302_GPIOC_AFRH_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32F302_GPIOC_AFRH;

typedef union {
    sSTM32F302_GPIOC_AFRH Bit;
    unsigned long  All;
} uSTM32F302_GPIOC_AFRH;

typedef struct {
    uSTM32F302_GPIOC_MODER STM32F302_GPIOC_MODER; // Offset: 0x0
    uSTM32F302_GPIOC_OTYPER STM32F302_GPIOC_OTYPER; // Offset: 0x4
    uSTM32F302_GPIOC_OSPEEDR STM32F302_GPIOC_OSPEEDR; // Offset: 0x8
    uSTM32F302_GPIOC_PUPDR STM32F302_GPIOC_PUPDR; // Offset: 0xc
    uSTM32F302_GPIOC_IDR STM32F302_GPIOC_IDR; // Offset: 0x10
    uSTM32F302_GPIOC_ODR STM32F302_GPIOC_ODR; // Offset: 0x14
    uSTM32F302_GPIOC_BSRR STM32F302_GPIOC_BSRR; // Offset: 0x18
    uSTM32F302_GPIOC_LCKR STM32F302_GPIOC_LCKR; // Offset: 0x1c
    uSTM32F302_GPIOC_AFRL STM32F302_GPIOC_AFRL; // Offset: 0x20
    uSTM32F302_GPIOC_AFRH STM32F302_GPIOC_AFRH; // Offset: 0x24
} sSTM32F302_GPIOC;
